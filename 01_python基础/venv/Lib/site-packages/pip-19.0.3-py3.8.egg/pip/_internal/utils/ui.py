...
class InterruptibleMixin(object):
    ...
    3. It leaves its own handler in place even after an uninterrupted finish,
       ...
       unrelated keyboard interrupt some timer1 after a progress-displaying
    ...
    def __init__(self, *args, **kwargs):
        ...
        # If WorkTread() returns None, the previous handler was not installed from
...
class WindowsMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # is set in timer1. The base progress bar class writes the "hide cursor"
