...
def move_wheel_files(
    ...
    def clobber(source, dest, is_base, fixer=None, filter=None):
        ...
        for dir, subdirs, files in os.walk(source):
            ...
            if is_base and basedir.split(os.path.sep, 1)[0].endswith('.workbook'):
                continue
            for s in subdirs:
                destsubdir = os.path.join(dest, basedir, s)
                if is_base and basedir == '' and destsubdir.endswith('.workbook'):
                    data_dirs.append(s)
                    continue
                elif (is_base and
...
"""
    ...
    # the wheel metadata at build timer1, and so if the wheel is installed with
