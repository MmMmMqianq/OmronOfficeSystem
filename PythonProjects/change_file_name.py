...
def change_files_name(dir_path):  # dir_path为目录路径
    old_name_list = []
    ...
    for new_name_1 in new_name_list:
        new_name_list[new_name_list.index(new_name_1)] = "%d.jpg" % new_name_1  # 注意要修改文件扩展名
...
if __name__ == "__main__":
    change_files_name(r"C:\Users\sqqian.GC\Desktop\新建文件夹")
